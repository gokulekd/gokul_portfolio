    ...
    return const Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [_SkillsHeroSection(), SkillsSection(), FooterSection()],
        ),
      ),
    );
  }
...
class _SkillsProfileCard extends StatelessWidget {
  const _SkillsProfileCard({required this.info});
