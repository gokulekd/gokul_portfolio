...
class SkillsHeroSection extends ConsumerWidget {
  const SkillsHeroSection({super.key});
              ...
              child: Column(
                ...
                children: [
                  ...
                  ConstrainedBox(
                    ...
                    child: Text(
                      'A focused look at the tools, technologies, and creative strengths I use to shape fast, polished digital products.',
                      style: GoogleFonts.manrope(
...
class SkillsProfileCard extends StatelessWidget {
  const SkillsProfileCard({super.key, required this.info});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const ProfileMetric(
            value: '6+',
            label: 'Core tools used across projects',
          ),
          const SizedBox(height: 14),
          const ProfileMetric(
            value: 'UI + Dev',
            label: 'Balanced product and implementation mindset',
          ),
          const SizedBox(height: 14),
          ProfileMetric(
            value: info.location,
            label: 'Available for remote collaboration',
          ),
        ],
      ),
    );
...
class HeroActionButton extends StatelessWidget {
  const HeroActionButton({super.key, required this.label,
    required this.icon,
